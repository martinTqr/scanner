...
export class FirstMigration1744226529881 implements MigrationInterface {
    name = 'FirstMigration1744226529881'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`document_item\` (\`id\` int NOT NULL AUTO_INCREMENT, \`code\` varchar(255) NOT NULL DEFAULT '', \`remito\` varchar(255) NOT NULL DEFAULT '', \`order\` varchar(255) NOT NULL DEFAULT '', \`name\` varchar(255) NOT NULL DEFAULT '', \`description\` varchar(255) NOT NULL DEFAULT '', \`dimensions\` varchar(255) NOT NULL DEFAULT '', \`unit\` varchar(255) NOT NULL DEFAULT '', \`quantity\` float NOT NULL DEFAULT '0', \`unitPrice\` float NOT NULL DEFAULT '0', \`bonus_1\` varchar(255) NOT NULL DEFAULT '', \`bonus_2\` varchar(255) NOT NULL DEFAULT '', \`bonus_3\` varchar(255) NOT NULL DEFAULT '', \`bonus_4\` varchar(255) NOT NULL DEFAULT '', \`weight\` varchar(255) NULL, \`length\` varchar(255) NULL, \`thickness\` varchar(255) NULL, \`amount\` float NOT NULL DEFAULT '0', \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`document_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`document\` (\`id\` int NOT NULL AUTO_INCREMENT, \`provider_name\` varchar(255) NULL, \`provider_cuit\` varchar(255) NULL, \`code\` varchar(255) NULL, \`date\` datetime NULL, \`expiration_date\` datetime NULL, \`observations\` varchar(1000) NULL, \`document_type\` enum ('FACTURA', 'NOTA CREDITO', 'NOTA DEBITO', 'RECIBO', 'COMPROBANTE COMPRA') NULL, \`receipt_type\` enum ('A', 'B', 'C', 'E', 'M') NULL, \`sell_condition\` varchar(255) NULL, \`cae_number\` bigint NOT NULL, \`cae_expiration_date\` datetime NULL, \`currency\` varchar(255) NULL, \`total\` float NOT NULL DEFAULT '0', \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`document_id\` int NULL, UNIQUE INDEX \`REL_78f5e16f1322a7b2b150364ddd\` (\`document_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`document_tax\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL DEFAULT '', \`value\` float NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`document_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
